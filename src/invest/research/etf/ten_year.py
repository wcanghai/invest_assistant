...
from invest.research.etf.config import LEGACY_STRATEGIES as STRATEGIES
...
from invest.storage.etf import digest
from invest.research.etf.strategies import features
...
def main():
    ...
    parser.add_argument("--output", type=Path, default=load_settings().root / "reports/ten-year")
