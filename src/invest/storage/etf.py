...
from invest.research.etf.config import CLASSES
from invest.research.etf.config import digest
...
def migrate(path):
    ...
    with connect(path) as conn:
        conn.executescript(Path(__file__).with_name("etf.sql").read_text())
