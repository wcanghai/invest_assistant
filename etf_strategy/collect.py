...
from .storage import connect, import_records, migrate, now
...
def collect(path, codes, start, end, raw_output, client=None):
    ...
    from security_pool.fetcher import init_tdx
    from stock_data.fetcher import fetch_daily_bars
    from stock_data.processor import flatten_daily_bars
    from security_pool.processor import parse_date
